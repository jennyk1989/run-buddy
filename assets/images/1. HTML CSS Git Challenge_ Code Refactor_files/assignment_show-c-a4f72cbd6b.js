(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[3689],{FZ6K:function(e,t,r){"use strict"
var a=r("An8g")
var s=r("VTBJ")
var n=r("q1tI")
var _=r.n(n)
...
var o=r("bZJi")
var d=r("ayAk")
function c(e){return _.a.createElement("a",Object.assign({rel:"noopener noreferrer",target:"_blank"},e),d["a"].t("SpeedGrader™"))}function i(e){const t=e.className?"icon-speed-grader "+e.className:"icon-speed-grader"
let r={className:t,href:e.href}
e.disabled&&(r=Object(s["a"])(Object(s["a"])({},r),{},{"aria-disabled":"true","aria-describedby":e.disabledTip,onClick:e=>{e.preventDefault()},role:"button",style:{opacity:.5}}))
return e.disabled?Object(a["a"])(o["a"],{placement:"bottom",tip:e.disabledTip,variant:"inverse"},void 0,c(r)):c(r)}t["a"]=i},QJn8:function(e,t,r){"use strict"
r.d(t,"a",(function(){return n}))
var a=r("ouhR")
var s=r.n(a)
r("XbwQ")
function n(){return s()(".vdd_tooltip_link").tooltip({position:{my:"center bottom",at:"center top-10",collision:"fit fit"},tooltipClass:"center bottom vertical",content(){const e=s()(this).data("tooltipSelector")
try{const t=document.querySelector(e)
return s()(t).html()}catch(e){}}})}},UWEG:function(e,t,r){"use strict"
var a=r("ouhR")
var s=r.n(a)
r("dhbk")
...
var n=r("ayAk")
r("q1tI")
function _(e){return Object(a["a"])("option",{value:e.id},e.id,e.name)}function o(e){return Object(a["a"])("optgroup",{label:e.name},"group_category_"+e.id,e.groups.map(e=>_(e)))}function d(e){return Object(a["a"])(s["a"],{id:"student-group-filter",label:e.label},void 0,Object(a["a"])("select",{onChange:t=>{e.onChange(t.target.value)},style:{margin:"0",width:"100%"},value:e.value||"0"},void 0,Object(a["a"])("option",{"aria-disabled":"true",disabled:"disabled",value:"0"},"0",n["a"].t("Select One")),e.categories.map(e=>o(e))))}t["a"]=d},jbBh:function(e,t,r){"use strict"
r.d(t,"a",(function(){return l}))
var a=r("ouhR")
var s=r.n(a)
var n=r("ayAk")
r("Dhso")
const _="re_upload_submissions_form"
function o({submissions_zip:e}){if(!e)return false
if(!e.match(/\.zip$/)){s()(this).formErrors({submissions_zip:n["a"].t("Please upload files as a .zip")})
return false}const t=this.find('button[type="submit"]')
t.attr("disabled",true)
t.text(n["a"].t("Uploading..."))
return true}function d(e){const t=s()("#"+_)
t.find('input[name="submissions_zip"]').remove()
t.removeAttr("enctype")
t.append(`<input type="hidden" name="attachment_id" value="${e.id}">`)
document.getElementById(_).submit()}function c(e){const t=this.find('button[type="submit"]')
t.attr("disabled",false)
t.text(n["a"].t("Upload Files"))
return this}function i(e){return{errorMessage:n["a"].t("Upload error. Please try again.")}}function l(e){const t={fileUpload:true,fileUploadOptions:{context_code:e,formDataTarget:"uploadDataUrl",intent:"submissions_zip_upload",preparedFileUpload:true,singleFile:true,upload_only:true,preferFileValueForInputName:false},object_name:"attachment",beforeSubmit:o,error:c,errorFormatter:i,success:d}
s()("#"+_).formSubmit(t)
return t}},xHU4:function(e,t,r){"use strict"
r.r(t)
var a=r("An8g")
var s=r("ik22")
var n=r("ayAk")
...
var m=r("mX+G")
var f=r.n(m)
var v=function(e,t){return function(){return e.apply(t,arguments)}},b=function(e,t){for(var r in t)h.call(t,r)&&(e[r]=t[r])
...
O.init({itemType:"assignment",page:"show"})
let T=[]
...
z()
R()
i["a"].put(`/api/v1/courses/${ENV.COURSE_ID}/gradebook_settings`,u.a.stringify({gradebook_settings:{filter_rows_by:{student_group_id:e}}})).finally(()=>{T=T.filter(e=>e!==t)
R()})}}function R(){const e=ENV.SETTINGS.filter_speed_grader_by_student_group&&(!ENV.selected_student_group_id||T.length>0)
const t=document.getElementById("speed_grader_link_mount_point")
t&&c.a.render(Object(a["a"])(V["a"],{disabled:e,href:ENV.speed_grader_url,disabledTip:n["a"].t("Must select a student group first")}),t)}function z(){const e=document.getElementById("student_group_filter_mount_point")
e&&c.a.render(Object(a["a"])(j["a"],{categories:ENV.group_categories,label:n["a"].t("Select Group to Grade"),onChange:C,value:ENV.selected_student_group_id}),e)}const A=document.getElementById("immersive_reader_mount_point")
const U=document.getElementById("immersive_reader_mobile_mount_point");(A||U)&&r.e(179).then(r.bind(null,"AZYJ")).then(e=>{var t,r
const a=null===(t=document.querySelector(".description"))||void 0===t?void 0:t.innerHTML
const s=null===(r=document.querySelector(".title"))||void 0===r?void 0:r.textContent
A&&e.initializeReaderButton(A,{content:a,title:s})
U&&e.initializeReaderButton(U,{content:a,title:s})}).catch(e=>{console.log("Error loading immersive readers.",e)})
const x=Promise.all([r.e(8),r.e(43),r.e(3647)]).then(r.bind(null,"fY8A"))
...
const r=new g["a"]({model:t,el:e})
r.render()
r.on("publish",()=>o()("#moderated_grading_button").show())
r.on("unpublish",()=>o()("#moderated_grading_button").hide())}x.then(()=>{o()("#sequence_footer").moduleSequenceFooter({courseID:ENV.COURSE_ID,assetType:"Assignment",assetID:ENV.ASSIGNMENT_ID,location:window.location})})
return Object(y["a"])()})
o()(()=>o()("#content").on("click","#mark-as-done-checkbox",(function(){return k["a"].toggle(this)})))
function B(e,t=true){e&&e.preventDefault()
c.a.render(Object(a["a"])(I["a"],{open:t,sourceCourseId:ENV.COURSE_ID,contentShare:{content_type:"assignment",content_id:ENV.ASSIGNMENT_ID},onDismiss:()=>{B(null,false)
o()(".al-trigger").focus()}}),document.getElementById("direct-share-mount-point"))}function M(e,t=true){e&&e.preventDefault()
c.a.render(Object(a["a"])(N["a"],{open:t,sourceCourseId:ENV.COURSE_ID,contentSelection:{assignments:[ENV.ASSIGNMENT_ID]},onDismiss:()=>{M(null,false)
o()(".al-trigger").focus()}}),document.getElementById("direct-share-mount-point"))}o()(()=>{o()(".direct-share-send-to-menu-item").click(B)
o()(".direct-share-copy-to-menu-item").click(M)})
o()(()=>{if(ENV.speed_grader_url){ENV.SETTINGS.filter_speed_grader_by_student_group&&z()
R()}})
...
G["default"].init(e,t)
document.getElementById("assignment_external_tools")&&w["a"].attach(document.getElementById("assignment_external_tools"),"assignment_view",parseInt(ENV.COURSE_ID,10),parseInt(ENV.ASSIGNMENT_ID,10))})
o()("#accessibility_warning").on("focus",(function(){o()("#accessibility_warning").removeClass("screenreader-only")}))
o()("#accessibility_warning").on("blur",(function(){o()("#accessibility_warning").addClass("screenreader-only")}))}}])

//# sourceMappingURL=assignment_show-c-a4f72cbd6b.js.map